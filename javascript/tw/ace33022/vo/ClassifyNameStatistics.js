 ...
 * @version 2014/12/19 調整成可提供requirejs、require(CommonJS格式)、load(Rhino格式)使用。
   ...
   var result = function() {
    ...
    this.getSchemaJSONObject = function() {
      ...
      var result = _.extend({}, uber.getSchemaJSONObject());
			...
			result.$schema = '/json-schema/VO/ClassifyNameStatistics';
			result.title = 'classify_name_statistics';

      result.properties.classify_name = {'description': '', 'type': 'string', 'maxLength': 8};
    ...
    RequireJSConfig = root.tw.ace33022.RequireJSConfig;
		...
		root.tw.ace33022.vo.ClassifyNameStatistics = result;
	}
})(this);