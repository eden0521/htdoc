/**
 *
 * @description DealerFutureDayTrnLog
 *
 * @require underscore.js
 * @require Ancestor.js
 * @require tw.ace33022.vo.ForeignFutureDayTrnLog
 *
 * @version 2013/10/29 ace 初始版本。
...
(function(root) {
    ...
    this.getSchemaJSONObject = function() {
      ...
      var result = _.extend({}, uber.getSchemaJSONObject());
			...
			result.$schema = '/json-schema/vo/DealerFutureDayTrnLog';
			result.title = 'dealer_future_day_trn_log';
	...
	if (typeof define === 'function') {
		...
		root.tw.ace33022.vo.DealerFutureDayTrnLog = result;
	}
})(this);