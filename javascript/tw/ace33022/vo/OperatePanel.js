...
(function(root) {
  ...
  var result = function() {
    ...
    var operatePanelName = new String('');	// 面版名稱
		var topPixel = new Number(0);						// 上邊界pixel值
		var leftPixel = new Number(0);					// 左邊界pixel值
		var widthPixel = new Number(0);					// 寬度pixel值
		var heightPixel = new Number(0);				// 高度pixel值
    ...
    this.setOperatePanelCode = function(value) { if (typeof value !== 'undefined') operatePanelCode = value; return value; }
		this.setOperatePanelName = function(value) { if (typeof value !== 'undefined') operatePanelName = value; return value; }
    ...
    this.getOperatePanelName = function() { return operatePanelName; }
    ...
    this.toJSONObject = function() {
      ...
      var result = {
        ...
        "operate_panel_name": this.getOperatePanelName(),
    ...
    this.setValueFromJSONObject = function(value) {
      ...
      this.setOperatePanelName(value["operate_panel_name"]);
    ...
    this.getSchemaJSONObject = function() {
      ...
      var result = root._.extend({}, uber.getSchemaJSONObject());
			...
			result["$schema"] = '/json-schema/vo/operate_panel';
			result["title"] = 'operate_panel';
      ...
      result["properties"]["operate_panel_code"] = {"description": "面版代碼", "type": "string", "maxLength": 5};
			result["properties"]["operate_panel_name"] = {"description": "面版名稱", "type": "string", "maxLength": 16};
	...
	if (typeof define === 'function') {
		...
		root.tw.ace33022.vo.OperatePanel = result;
	}
})(this);