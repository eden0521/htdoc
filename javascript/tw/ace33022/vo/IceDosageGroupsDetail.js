...
(function(root) {
  ...
  var result = function() {
    ...
    var serialVersionUID = new Number(1);	// 保留
		...
		var iceDosageCode = new String('');				// 代碼
    ...
    this.getSchemaJSONObject = function() {
      ...
      var result = root._.extend({}, uber.getSchemaJSONObject());
			...
			result.$schema = '/json-schema/vo/ice_dosage_groups_detail';
			result.title = 'ice_dosage_groups_detail';
	...
	if (typeof define == 'function') {
		...
		root.tw.ace33022.vo.IceDosageGroupsDetail = result;
	}
})(this);