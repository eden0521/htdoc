/**
 *
 * @description InestFutureOptionDayTrnLog(投信每日期貨/選擇權交易統計資料)
 *
...
(function(root) {
    ...
    this.getSchemaJSONObject = function() {
      ...
      var result = _.extend({}, uber.getSchemaJSONObject());
			...
			result.$schema = '/json-schema/VO/InvestFutureOptionDayTrnLog';
			result.title = 'invest_future_option_day_trn_log';
	...
	if (typeof define === 'function') {
		...
		root.tw.ace33022.vo.InvestFutureOptionDayTrnLog = result;
	}
})(this);