/**
 *
 * @description InvestOptionDayTrnLog
 *
...
(function(root) {
    ...
    this.getSchemaJSONObject = function() {
      ...
      var result = _.extend({}, uber.getSchemaJSONObject());
			...
			result.$schema = '/json-schema/VO/InvestOptionDayTrnLog';
			result.title = 'invest_option_day_trn_log';
	...
	if (typeof define === 'function') {
		...
		root.tw.ace33022.vo.InvestOptionDayTrnLog = result;
	}
})(this);