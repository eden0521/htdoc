...
(function(root) {
	...
	define(['tw.ace33022.vo.Programs', 'tw.ace33022.dao.vo.Programs', 'tw.ace33022.vo.OperatePanelsDetail', 'tw.ace33022.dao.vo.OperatePanelsDetail', 'tw.ace33022.vo.OperatePanels', 'tw.ace33022.dao.vo.OperatePanels', 'tw.ace33022.dao.SYS00010', 'tw.ace33022.utils.Browser.BaseForms', 'custombox', 'jquery', 'jquery.ui.progressbar'], function(Programs, ProgramsDAO, OperatePanelsDetail, OperatePanelsDetailDAO, OperatePanels, OperatePanelsDAO, SYS00010, BaseForms, Custombox) {
		...
		var showMessage = function() {
			...
			requirejs(["jquery.ui.dialog"], function() {
			
				var frmId = 'frmShowMessage';
				var tag = '<div id="' + frmId + '" style="display: none; padding: 20px; text-align: center;">' + message + '</div>';
				var options = {
				...
				jQuery('#' + frmId).addClass('ace-font');
				
				jQuery('.ui-dialog-title').addClass('ace-font');
				jQuery('.ui-button-text').addClass('ace-font');
			});
		};
		...
		var showProgressbar = function(closeCallback) {
			...
			Custombox.open({
				...
				complete: function() {
					...
					if (typeof closeCallback === 'function') closeCallback(jQuery('#' + frmId));
				}
			});
		};
