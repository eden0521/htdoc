  ...
  var result = function(conn) {
    ...
    this.doInsert = function(vo, callback) {
      ...
      strSQL = 'insert into ' + tableName + ' '
             + '(user_code, user_tel, invalid_flag, insert_date, insert_time, insert_user_code, update_date, update_time, update_user_code) '
             + 'values '
             + '($user_code, $user_tel, $invalid_flag, $insert_date, $insert_time, $insert_user_code, $update_date, $update_time, $update_user_code) ';
      conn.run(strSQL, {

          $user_code: vo.getUserCode(),
          $user_tel: vo.getUserTel(),
    ...
    this.doSelectByUserTel = function(userTel, callback) {
	...
	if (typeof define === 'function') {
		...
		define(['underscore', 'AncestorDAO', 'UserTels'], function(underscore, dAncestorDAO, dUserTels) {
		...
		accessVO = require(RequireJSConfig.paths['UserTels'] + '.js');
