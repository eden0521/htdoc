...
(function(root) {
    ...
    this.prototype = this;  	// 由於已複製父類別Ancestor，因此原型類別指向自己。
		...
		this.setDAO(new Packages.tw.ace33022.dao.db.vo.Roles(conn));
		
		this.doInsert = function(vo) {

			var javaVO = new Packages.tw.ace33022.vo.Roles();
	...
	if (typeof define == 'function') {
		...
		define(["tw.ace33022.vo.Roles", "tw.ace33022.dao.db.vo.Ancestor", "underscore"], function(Roles, Ancestor) {
		...
		accessVO = require(RequireJSConfig.paths["tw.ace33022.vo.Roles"] + '.js');
		...
		if (typeof load != 'undefined') {
			...
			if (typeof root.tw.ace33022.vo.Roles == 'undefined') load(RequireJSConfig.baseUrl + RequireJSConfig.paths["tw.ace33022.vo.Roles"] + '.js');
		...
		accessVO = root.tw.ace33022.vo.Roles;
		ancestor = root.tw.ace33022.dao.db.vo.Ancestor;
		
		root.tw.ace33022.dao.db.vo.Roles = result;
	}    
})(this);