...
(function() {
	...
	var result = function(conn) {
		...
		var tableName = 'foreign_stocks_day_trn_logs';
	...
	if (typeof define === 'function') {
		...
		define(['underscore', 'AncestorDAO', 'ForeignStocksDayTrnLogs'], function(underscore, dAncestorDAO, dForeignStocksDayTrnLogs) {
		
			_ = underscore;
			
			ancestorDAO = dAncestorDAO;
			accessVO = dForeignStocksDayTrnLogs;
		...
		accessVO = require(RequireJSConfig.paths['ForeignStocksDayTrnLogs'] + '.js');
		...
		accessVO = root.ForeignStocksDayTrnLogs;
		
		root['ForeignStocksDayTrnLogsDAO'] = result;
	}    
})();