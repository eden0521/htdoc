...
(function(root) {
    ...
    this.prototype = this;  	// 由於已複製父類別Ancestor，因此原型類別指向自己。
		...
		this.setDAO(new Packages.tw.ace33022.dao.db.vo.Departments(conn));
		
		this.doInsert = function(vo) {

			var javaVO = new Packages.tw.ace33022.vo.Departments();
	...
	if (typeof define == 'function') {
		...
		define(["tw.ace33022.vo.Departments", "tw.ace33022.dao.db.vo.Ancestor", "underscore"], function(Departments, Ancestor) {
		
			accessVO = Departments;
			ancestor = Ancestor;
		...
		accessVO = require(RequireJSConfig.paths["tw.ace33022.vo.Departments"] + '.js');
		...
		if (typeof load != 'undefined') {
			...
			if (typeof root.tw.ace33022.vo.Departments == 'undefined') load(RequireJSConfig.baseUrl + RequireJSConfig.paths["tw.ace33022.vo.Departments"] + '.js');
		...
		accessVO = root.tw.ace33022.vo.Departments;
		ancestor = root.tw.ace33022.dao.db.vo.Ancestor;
		
		root.tw.ace33022.dao.db.vo.Departments = result;
	}    
})(this);