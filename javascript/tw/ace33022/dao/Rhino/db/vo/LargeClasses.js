...
(function(root) {
    ...
    this.prototype = this;  	// 由於已複製父類別Ancestor，因此原型類別指向自己。
		...
		this.setDAO(new Packages.tw.ace33022.dao.db.vo.LargeClasses(conn));
		
		this.doInsert = function(vo) {

			var javaVO = new Packages.tw.ace33022.vo.LargeClasses();
	...
	if (typeof define == 'function') {
		...
		define(["tw.ace33022.vo.LargeClasses", "tw.ace33022.dao.db.vo.Ancestor", "underscore"], function(LargeClasses, Ancestor) {
		
			accessVO = LargeClasses;
			ancestor = Ancestor;
		...
		accessVO = require(RequireJSConfig.paths["tw.ace33022.vo.LargeClasses"] + '.js');
		...
		if (typeof load != 'undefined') {
			...
			if (typeof root.tw.ace33022.vo.LargeClasses == 'undefined') load(RequireJSConfig.baseUrl + RequireJSConfig.paths["tw.ace33022.vo.LargeClasses"] + '.js');
		...
		accessVO = root.tw.ace33022.vo.LargeClasses;
		ancestor = root.tw.ace33022.dao.db.vo.Ancestor;
		
		root.tw.ace33022.dao.db.vo.LargeClasses = result;
	}    
})(this);