...
(function(root) {
    ...
    this.prototype = this;  	// 由於已複製父類別Ancestor，因此原型類別指向自己。
		...
		this.setDAO(new Packages.tw.ace33022.dao.db.vo.SugarGroups(conn));
		
		this.doInsert = function(vo) {

			var javaVO = new Packages.tw.ace33022.vo.SugarGroups();
	...
	if (typeof define == 'function') {
		...
		define(["tw.ace33022.vo.SugarGroups", "tw.ace33022.dao.db.vo.Ancestor", "underscore"], function(SugarGroups, Ancestor) {
		
			accessVO = SugarGroups;
			ancestor = Ancestor;
		...
		accessVO = require(RequireJSConfig.paths["tw.ace33022.vo.SugarGroups"] + '.js');
		...
		if (typeof load != 'undefined') {
			...
			if (typeof root.tw.ace33022.vo.SugarGroups == 'undefined') load(RequireJSConfig.baseUrl + RequireJSConfig.paths["tw.ace33022.vo.SugarGroups"] + '.js');
		...
		accessVO = root.tw.ace33022.vo.SugarGroups;
		ancestor = root.tw.ace33022.dao.db.vo.Ancestor;
		
		root.tw.ace33022.dao.db.vo.SugarGroups = result;
	}    
})(this);