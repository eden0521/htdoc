...
(function() {
	...
	var result = function(conn) {
		...
		var tableName = 'dealer_stocks_day_trn_logs';
	...
	if (typeof define === 'function') {
		...
		define(['underscore', 'AncestorDAO', 'DealerStocksDayTrnLogs'], function(underscore, dAncestorDAO, dDealerStocksDayTrnLogs) {
		
			_ = underscore;
			
			ancestorDAO = dAncestorDAO;
			accessVO = dDealerStocksDayTrnLogs;
		...
		accessVO = require(RequireJSConfig.paths['DealerStocksDayTrnLogs'] + '.js');
		...
		if (typeof root.DealerStocksDayTrnLogs === 'undefined') load(RequireJSConfig.baseUrl + RequireJSConfig.paths['DealerStocksDayTrnLogs'] + '.js');
		
		_ = root._;
		
		ancestorDAO = root.AncestorDAO;
		accessVO = root.DealerStocksDayTrnLogs;
		
		root['DealerStocksDayTrnLogsDAO'] = result;
	}    
})();