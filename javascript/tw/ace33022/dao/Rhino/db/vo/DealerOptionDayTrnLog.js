/**
 *
 * @description tw.ace33022.dao.db.vo.DealerOptionDayTrnLog(自營商每日選擇權交易統計資料)
 *
 * @return {Object} DealerOptionDayTrnLog
 *
 * @require underscore.js
 * @require tw.ace33022.dao.db.vo.ForeignOptionDayTrnLog
 * @require tw.ace33022.vo.DealerOptionDayTrnLog
 *
...
(function(root) {
	...
	var result = function(conn) {
		...
		// this.setTableName('dealer_option_day_trn_log');
		this.setAccessVO(accessVO);
		this.setDAO(new Packages.tw.ace33022.dao.db.vo.DealerOptionDayTrnLog(conn));
		
		this.doInsert = function(vo) {

			var javaVO = new Packages.tw.ace33022.vo.DealerOptionDayTrnLog();
	...
	if (typeof define === 'function') {
		...
		define(["tw.ace33022.dao.db.vo.ForeignOptionDayTrnLog", "tw.ace33022.vo.DealerOptionDayTrnLog", "underscore"], function(Ancestor, DealerOptionDayTrnLog) {
		
			ancestor = Ancestor;
			accessVO = DealerOptionDayTrnLog;
		...
		accessVO = require(RequireJSConfig.paths["tw.ace33022.vo.DealerOptionDayTrnLog"] + '.js');
		...
		if (typeof load !== 'undefined') {
			...
			if (typeof root.tw.ace33022.vo.DealerOptionDayTrnLog === 'undefined') load(RequireJSConfig.baseUrl + RequireJSConfig.paths["tw.ace33022.vo.DealerOptionDayTrnLog"] + '.js');
		}
		
		ancestor = root.tw.ace33022.dao.db.vo.ForeignOptionDayTrnLog;
		accessVO = root.tw.ace33022.vo.DealerOptionDayTrnLog;
		
		root.tw.ace33022.dao.db.vo.DealerOptionDayTrnLog = result;
	}    
})(this);