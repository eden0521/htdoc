...
(function(root) {
    ...
    this.prototype = this;  	// 由於已複製父類別Ancestor，因此原型類別指向自己。
		...
		this.setDAO(new Packages.tw.ace33022.dao.db.vo.Users(conn));
		
		this.doInsert = function(vo) {

			var javaVO = new Packages.tw.ace33022.vo.Users();
	...
	if (typeof define === 'function') {
		...
		define(["tw.ace33022.vo.Users", "tw.ace33022.dao.vo.Ancestor", "underscore"], function(Users, Ancestor) {
		...
		accessVO = require(RequireJSConfig.paths["tw.ace33022.vo.Users"] + '.js');
		...
		if (typeof load != 'undefined') {
			...
			if (typeof root.tw.ace33022.vo.Users == 'undefined') load(RequireJSConfig.baseUrl + RequireJSConfig.paths["tw.ace33022.vo.Users"] + '.js');
		...
		accessVO = root.tw.ace33022.vo.Users;
		ancestor = root.tw.ace33022.dao.db.vo.Ancestor;
		
		root.tw.ace33022.dao.db.vo.Users = result;
	}    
})(this);