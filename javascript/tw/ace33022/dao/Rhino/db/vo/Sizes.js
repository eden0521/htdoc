...
(function(root) {
    ...
    this.prototype = this;  	// 由於已複製父類別Ancestor，因此原型類別指向自己。
		...
		this.setDAO(new Packages.tw.ace33022.dao.db.vo.Sizes(conn));
		
		this.doInsert = function(vo) {

			var javaVO = new Packages.tw.ace33022.vo.Sizes();
	...
	if (typeof define == 'function') {
		...
		define(["tw.ace33022.vo.Sizes", "tw.ace33022.dao.db.vo.Ancestor", "underscore"], function(Sizes, Ancestor) {
		...
		accessVO = require(RequireJSConfig.paths["tw.ace33022.vo.Sizes"] + '.js');
		...
		if (typeof load != 'undefined') {
			...
			if (typeof root.tw.ace33022.vo.Sizes == 'undefined') load(RequireJSConfig.baseUrl + RequireJSConfig.paths["tw.ace33022.vo.Sizes"] + '.js');
		...
		accessVO = root.tw.ace33022.vo.Sizes;
		ancestor = root.tw.ace33022.dao.db.vo.Ancestor;
		
		root.tw.ace33022.dao.db.vo.Sizes = result;
	}    
})(this);