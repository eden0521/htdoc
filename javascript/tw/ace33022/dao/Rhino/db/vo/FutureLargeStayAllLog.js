/**
 *
 * @description FutureLargeStayLog(期貨大額交易人未沖銷部位資料(全部月份合計))
 *
 * @require underscore
 * @require tw.ace33022.dao.db.vo.Ancestor
 * @require tw.ace33022.vo.FutureLargeStayLog
 * 
 * @version 2013/10/28 ace 初始版本。
...
(function(root) {
	...
	var result = function(conn) {
		...
		this.setTableName('future_large_stay_all_log');
	...
	if (typeof define === 'function') {
		...
		define(["tw.ace33022.dao.db.vo.Ancestor", "tw.ace33022.vo.FutureLargeStayAllLog", "underscore"], function(Ancestor, FutureLargeStayAllLog) {
		
			ancestor = Ancestor;
			accessVO = FutureLargeStayAllLog;
		...
		accessVO = require(RequireJSConfig.paths["tw.ace33022.vo.FutureLargeStayAllLog"] + '.js');
		...
		accessVO = root.tw.ace33022.vo.FutureLargeStayAllLog;
		
		root.tw.ace33022.dao.db.vo.FutureLargeStayAllLog = result;
	}
})(this);